        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2">
          {insights.map((post) => (
            ...
            >
              ...
              <div className="p-7">
                <span className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold uppercase tracking-wider ${categoryColors[post.category] || "bg-primary/10 text-primary"}`}>
                  {post.category}
                </span>
